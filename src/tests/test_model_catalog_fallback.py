...
def test_phi_catalog_pins_primary_source_and_keeps_checksum() -> None:
    ...
    assert cfg["sources"][0].endswith("/resolve/915429c/microsoft_Phi-4-mini-instruct-Q4_K_M.gguf")
    assert cfg["sources"][1].endswith("/resolve/main/microsoft_Phi-4-mini-instruct-Q4_K_M.gguf")
