...
python -m PyInstaller ^
    ...
    --workpath="%BUILD_DIR%" ^
    --specpath="%BUILD_DIR%" ^
    "%PROJECT_ROOT%src\promptsmith\cli\launcher.py"
...
echo   https://aka.ms/vs/17/release/vc_redist.x64.exe
echo.
echo Project home: https://github.com/pr0z4k/promptsmith-cli
echo Support:      https://github.com/pr0z4k/promptsmith-cli/issues
